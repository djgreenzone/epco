...
const SERVICES: Service[] = [
  ...
  },
  {
    ...
    title: "Sales Funnels",
    body: "The path from click to checkout, engineered. Every step strips friction and pulls the buyer one decision closer — the conversion backbone behind eight-figure launches.",
  ...
  },
  {
    ...
    body: "The asset every channel points to. High-conversion sites built for speed and performance — engineered by our web team.",
...
const SOLUTIONS: Solution[] = [
  ...
  },
  {
    ...
    body: "Conversion-first sites engineered for speed across every device — award-worthy design wired for conversion, so every campaign lands on a page built to turn clicks into customers.",
